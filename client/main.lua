...
function OpenBennysActionsMenu()
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job.job_grade == 'boss' then 
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bennys_actions', {
		...
		elseif data.current.value == 'vehicle_list' then
			if Config.EnableSocietyOwnedVehicles then
				...
				if Config.EnablePlayerManagement and ESX.PlayerData.job and (ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'assistant_manager' or ESX.PlayerData.job.grade_name == 'mecano_chef' or ESX.PlayerData.job.grade_name == 'formator' or ESX.PlayerData.job.grade_name == 'senior_mecano') then
...
function OpenBennysHarvestMenu()
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'apprentice' then
		local elements = {
...
AddEventHandler('esx_bennysjob:hasEnteredMarker', function(zone)
	...
	elseif zone == 'VehicleActions' then
		...
		CurrentActionMsg  = _U('open_actions')
		CurrentActionData = {}
	elseif zone == 'VehicleActions2' then
		CurrentAction     = 'bennys_actions_menu'
		CurrentActionMsg  = _U('open_actions')
		CurrentActionData = {}
	elseif zone == 'BossActions' then
		...
		CurrentActionMsg  = _U('open_actions')
		CurrentActionData = {}
	elseif zone == 'BossActions2' then
		CurrentAction     = 'boss_actions_menu'
		CurrentActionMsg  = _U('open_actions')
		CurrentActionData = {}
	elseif zone == 'CloakroomActions' then
		CurrentAction	  = 'cloakroom_actions_menu'
		CurrentActionMsg  = _('open_actions')
		CurrentActionData = {}
	elseif zone == 'CloakroomActions2' then
		CurrentAction	  = 'cloakroom_actions_menu'
		CurrentActionMsg  = _('open_actions')
		CurrentActionData = {}
	elseif zone == 'InventoryActions' then
		CurrentAction = 'inventory_actions_menu'
		CurrentActionMsg = _U('open_actions')
		CurrentActionData = {}
	elseif zone == 'InventoryActions2' then
		CurrentAction = 'inventory_actions_menu'
		CurrentActionMsg = _U('open_actions')
		CurrentActionData = {}
...
Citizen.CreateThread(function()
	...
	local blip2 = AddBlipForCoord(Config.Zones.BennysActions2.Pos.x, Config.Zones.BennysActions2.Pos.y, Config.Zones.BennysActions2.Pos.z)
